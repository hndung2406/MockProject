								...
								<div class="col-lg-12">
									<form role="form" class="form col-lg-11" action="addProduct"
										...
										<div class="form-group row">
											<label>Product Code</label> <input class="form-control" name="productForm.id" id="productFormId" placeholder="Example P0001" required="required" pattern="(P[A-Za-z0-9]{2,4})|(p[A-Za-z0-9]{2,4})">
										</div>
										<div class="form-group row">
											<label>Product Name</label> <input class="form-control" name="productForm.name" placeholder="Product Name" required="required">
										</div>
										<div class="form-group row">
											<label>Product Price</label> <input type="number"
												class="form-control" name="productForm.price"
												placeholder="Product Price" required="required">

										</div>
										<div class="form-group row">
											<label>Product Description</label> <input class="form-control" name="productForm.description" placeholder="Product Description" required="required">
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											<label>Product Quantity</label> <input type="number"
												class="form-control" name="productForm.quantity"
										...
										<div class="form-group row">
											<label>Product Condition</label> <input class="form-control"
												...
												placeholder="Condition of Product" required="required">

										</div>
										<div class="form-group row">
											<label>Product Spec</label> <input class="form-control"
												name="productForm.spec" placeholder="Product Spec"
												required="required">
										</div>
										<div class="form-group row">
										...
										<div class="form-group col-lg-2 row" style="padding-left: 0;">
											<label>Manufacturer</label> <select
												name="manufacture.manufactureId">
										...
										<div class="row col-lg-12" style="padding-left: 0;">
											<button type="submit" class="btn btn-default"
												style="background-color: #FFA500; font-weight: bold;">Submit</button>
